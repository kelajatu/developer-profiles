  ...
  render() {
    return (
      <LandingPageDiv>
        ...
        <Moreinfo>
          <Aboutus>
            <h2 id="aboutus">Asymmetrical master</h2> 
            <p>cleanse raclette kitsch, tofu next
          ...
          <Learnmore>
            <h2 id="learnmore">Street art crucifix</h2>
            <p>dolor amet plaid YOLO unicorn ramps tousled.
